...
public class NumberList
{
	...
	public NumberList()
	{
		...
		this.ctypeList = new Character[100];
		this.count = 0;
	}
	 ...
	 */
	public void addToList(Number num, Character ctype)
	{
		...
		this.ctypeList[this.count] = ctype;
		count++;
	...
	public void print()
	{
		...
		// *** Assume there's enough space in the arrays.
		// ***
		for (int i = 0;i<this.count;i++) System.out.println(this.numList[i].toString()+" ("+this.ctypeList[i].toString()+")");
