...
public class ParenChecker
{
	 ...
	 * 
	 * @param expression
	 *            A String containing the expression to be examined
	...
	/**
	 * Method to determine whether a character is one of the opening
	 * parentheses.
	 * 
	 * @param ch
	...
	/**
	 * Method to determine whether a character is one of the closing
	 * parentheses.
	 * 
	 * @param ch
	 *            Character to be tested
	...
	/**
	 * main method. Ask the user for a string and call the ParenChecker to see
	...
	public static void main(String args[])
	{
		String expression = JOptionPane
				.showInputDialog("Enter an expression containing parentheses");
