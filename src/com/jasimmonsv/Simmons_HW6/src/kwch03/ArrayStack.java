...
public class ArrayStack<E> implements StackInt<E>
{
	...
	/**
	 * Return the top item on the stack Pre: The stack is not empty Post: The
	 ...
	 * 
	 * @post The size of the data array has been doubled and all of the data has
	 *       been copied to the new array
	 */
