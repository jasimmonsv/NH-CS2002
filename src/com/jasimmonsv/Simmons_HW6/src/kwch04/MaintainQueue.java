...
public class MaintainQueue
{
	...
	public void processCustomers()
	{
		...
		while (choiceNum < choices.length - 1)
		{
			...
			choiceNum = JOptionPane.showOptionDialog(null, "Select an operation on customer queue",
					"Queue menu", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,
			...
			try
			{
				...
				case 0:
					...
					break;
				case 1:
					JOptionPane.showMessageDialog(null, "Customer " + customers.element()
							+ " is next in the queue");
					break;
				case 2:
					JOptionPane.showMessageDialog(null, "Customer " + customers.remove()
				...
				case 4:
					...
					for (String nextName : customers)
					{
						...
						{
							JOptionPane.showMessageDialog(null, "The number of customers ahead of "
									+ name + " is " + countAhead);
