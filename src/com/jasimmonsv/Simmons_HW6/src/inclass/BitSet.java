...
/**
 * Implementation of a set of numbered bits. This class's interface differs from
 * the {@link structure.Set}, {@link java.util.Bitset}, and
 * {@link java.util.Set} interfaces, so care must be taken to invoke the proper
 * methods.
 * 
...
public class BitSet
{
	 ...
	 * 
	 * @param count
	 *            The number of distinct values possibly in set.
	 */
	...
	/**
	 * Adds a bit to the bitset, if not already there. Set is potentially
	 * extended.
	 * 
	 * @pre i >= 0
	 ...
	 * 
	 * @param i
	 *            The number of the bit to be added.
	 */
	 ...
	 * 
	 * @param i
	 *            The index of the bit to be removed.
	 */
	 ...
	 * 
	 * @param count
	 *            The new capacity of the newly empty set.
	 */
	...
	/**
	 * Compute a new set that is the union of this set and other. Elements of
	 * the new set appear in at least one of the two sets.
	 * 
	...
	/**
	 * Return the intersection of this set and the other. A bit is in the result
	 * if it is in this set and other.
	 * 
	 * @pre other is not null
	 * @post constructs set w/elements in this and other
	 * 
	 * @param other
	 *            The other set to be intersected with this.
	 */
	...
	/**
	 * Computes the difference between this set and the other. An element is in
	 * the difference if it is in this, but not in other.
	 * 
	 * @pre other is not null
	 * @post constructs set w/elements from this but not other
	 * 
	 * @param other
	 *            The difference between this set and other.
	 */
	...
	/**
	 * Returns true iff this set is a subset of the other. A set is a subset of
	 * another if its elements are elements of the other.
	 * 
	 * @pre other is not null
