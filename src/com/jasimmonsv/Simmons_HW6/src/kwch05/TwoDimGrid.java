...
public class TwoDimGrid extends JPanel implements GridColors
{
	...
	/**
	 * Set the color of each square in the grid that correspond to the elements
	 * of the given array with the value 1
	 * 
	 * @param bitMap
	 *            - An array of 0's and 1's the same size as the grid
	 * @param aColor
	 *            - The color to be set
	 * @throws ArrayIndexOutOfBounds
	 *             if the array size and the grid size differ
	 */
